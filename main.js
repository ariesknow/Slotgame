...
function medalFlowView(){		//medalMoveの実行	
	payoutView();
	setTimeout("medalMove()",1500);
}

function LTChecker(){		//左下からの揃い判定
	switch(checkLT){
		case 2:
		case 7:
		case 12:
